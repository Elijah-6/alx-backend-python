...
Functions:
    element_length(lst: List[str]) -> List[Tuple[str, int]]:
        Computes the length of each string in the input list and returns a list of tuples,
        where each tuple contains a string and its corresponding length.
Args:
    lst (List[str]): A list of strings.
Returns:
    List[Tuple[str, int]]: A list of tuples, each containing a string from the input list and its length.
"""
